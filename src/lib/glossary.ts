...
export const GLOSSARY: Record<string, string> = {
  ...
  세후이자: "이자에서 이자소득세 15.4%를 뗀 뒤 실제로 손에 들어오는 이자예요. 로드맵의 적금 예상액은 이 기준으로 계산해요.",
  중위소득: "국민 전체를 소득순으로 줄 세웠을 때 정확히 가운데에 있는 사람의 소득이에요. 정책 지원 대상 판단 기준으로 자주 쓰여요.",
  "기준 중위소득": "보건복지부가 해마다 고시하는 복지사업 선정 기준선이에요. 가구원 수별로 정해지며, 정책상품 참여 자격을 따질 때 이 금액의 몇 % 이하인지를 봐요.",
