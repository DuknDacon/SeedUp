  ...
  return (
    <>
        ...
        <div className="max-w-5xl mx-auto px-4 pt-16 pb-24 grid md:grid-cols-2 gap-10 items-center">
          <Reveal>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-slate-900 mb-5">
              사회초년생의 첫 시드머니,
              <br />
              <span className="text-brand-600">AI</span>와 함께 만드세요
            </h1>
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <Reveal>
          <h2 className="text-2xl font-bold text-slate-900 mb-2 flex items-center gap-2">
            <ShieldCheck size={22} className="text-sprout-600" />
            믿을 수 있는 이유
          </h2>
          <p className="text-slate-500 mb-10">
          ...
          {TRUST_ITEMS.map((item, i) => (
            <Reveal key={item} delay={i * 0.08}>
              <div className="flex items-start gap-3 p-4 rounded-lg bg-sprout-50/60 border border-sprout-100">
                <ShieldCheck size={16} className="text-sprout-600 mt-0.5 flex-shrink-0" />
      ...
      <footer className="border-t border-slate-200 py-10">
        <div className="max-w-5xl mx-auto px-4 text-xs text-slate-400 space-y-2">
          <p>
