    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 pt-16 pb-24 grid md:grid-cols-2 gap-10 items-center">
          <Reveal>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sprout-50 dark:bg-sprout-500/10 text-sprout-600 dark:text-sprout-400 text-xs font-semibold mb-5">
              <Sparkles size={13} />
              사회초년생 맞춤 AI 비서
            </span>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight text-slate-900 dark:text-white mb-5 break-keep">
              사회초년생의 첫 시드머니, <span className="text-brand-600 dark:text-brand-400">AI</span>와
              함께 만드세요
            </h1>
            <p className="text-slate-600 dark:text-slate-300 text-base leading-relaxed mb-8 break-keep">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {PAIN_POINTS.map((p, i) => (
            <Reveal key={p.title} direction={i === 0 ? "left" : "right"} delay={0.1}>
              <div className="h-full p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                <h3 className="font-semibold text-slate-900 dark:text-white mb-2 break-keep">
                  {p.title}
                </h3>
            ...
            {STEPS.map((s, i) => (
              <Reveal key={s.title} delay={i * 0.12}>
                <div className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 h-full">
                  <div className="w-11 h-11 rounded-lg bg-brand-50 dark:bg-brand-500/10 text-brand-600 dark:text-brand-400 grid place-items-center mb-4">
                    <s.icon size={20} />
                  </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {TRUST_ITEMS.map((item, i) => (
            <Reveal key={item} delay={i * 0.08}>
              <div className="flex items-start gap-3 p-4 rounded-lg bg-sprout-50/60 dark:bg-sprout-500/10 border border-sprout-100 dark:border-sprout-500/20">
                <ShieldCheck
                  size={16}
                  className="text-sprout-600 dark:text-sprout-500 mt-0.5 flex-shrink-0"
                />
                <p className="text-sm text-slate-700 dark:text-slate-300 leading-relaxed break-keep">
                  {item}
                </p>
              </div>
            </Reveal>
      ...
      <section className="max-w-3xl mx-auto px-4 py-24 text-center">
        <Reveal>
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8 break-keep">
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 py-10">
        <div className="max-w-5xl mx-auto px-4 text-xs text-slate-400 dark:text-slate-500 space-y-2 break-keep">
          <p>
